...
out/e0/E0_SUMMARY.md, figures under figures/e0/. Deterministic, CPU-only.
  ...
  python e0_geometry.py --probes-root ../../stage5/probes \
      --probe-cards ../../stage6/artifacts/probe_cards.json \
...
# cycle orders from stage6/code/plots.py CYCLES; npz class names use
...
def main():
    ...
    ap.add_argument("--probes-root", default=str(root / "stage5/probes"))
    ap.add_argument("--probe-cards",
                    default=str(root / "stage6/artifacts/probe_cards.json"))
