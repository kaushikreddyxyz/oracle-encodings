...
rely on these):
- stage5/natstats26.npz: keys ``mean_{l}``/``std_{l}`` for l = 0..25, each
...
- stage5/probes/<family>/probes_l{L}.npz: ``classes`` [C] str,
...
- stage6/data/natscores/<family>.natscores.npz: ``preds_ridge``
  [12, n_tokens, C] fp32 = z @ W_ridge_chosen.T + b_ridge_chosen (raw
  non-unit W, bias INCLUDED — verified in stage6/code/score_natural.py
...
NATSTATS_PATH = CP_DIR / "stage5" / "natstats26.npz"
