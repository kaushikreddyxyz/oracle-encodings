...
Reads 1_dataset/data/<family>/judged/judged_nat.jsonl, tokenizes with the gemma-2
...
writes 3_validation/data/natural/eval/<family>.jsonl with one row per example:
