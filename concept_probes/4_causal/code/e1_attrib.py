...
- Primary pool: 1_dataset/data/<family>/judged/judged_nat.jsonl.
...
- Fallback (used when natural positives < --min-natural, default 50; e.g.
  ...
  1_dataset/data/<family>/final/mixed/<class>.val.jsonl — role target_pos as
...
Outputs (--out, default 4_causal/out/e1):
...
STAGE4_DATA = CP_DIR / "1_dataset" / "data"
PROMPTS_DIR = STAGE_DIR / "prompts"
PROBE_CARDS = CP_DIR / "3_validation" / "artifacts" / "probe_cards.json"
