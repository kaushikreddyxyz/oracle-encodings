...
- 10 neutral ClimbMix prefixes sampled deterministically from the Stage-6
  natural random pool (stage6/data/natural/random_pool.jsonl; fields
  ...
  of stage4/data/<family>/judged/judged_nat.jsonl. Each prefix is truncated to
...
- Layer: the concept's chosen layer from stage6/artifacts/probe_cards.json
...
CARDS_PATH = common.CP_DIR / "stage6" / "artifacts" / "probe_cards.json"
POOL_PATH = common.CP_DIR / "stage6" / "data" / "natural" / "random_pool.jsonl"
STAGE4_DATA = common.CP_DIR / "stage4" / "data"
