...
- PRIMARY: stage6/data/natural/eval/<family>.jsonl — the Stage-6 tokenized
  derivative of stage4/data/<family>/judged/judged_nat.jsonl (fields verified
...
- FALLBACK (natural positives < 50; affects color_wheel x4, directions x2,
  moon_phases x5): stage4/data/<family>/final/mixed/<class>.val.jsonl rows
...
NATEVAL_DIR = CP_DIR / "stage6" / "data" / "natural" / "eval"
STAGE4_DIR = CP_DIR / "stage4"
